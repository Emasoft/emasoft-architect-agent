...
allowed-tools: ["Bash(python3 ${CLAUDE_PLUGIN_ROOT}/scripts/eaa_start_planning.py:*)"]
---
...
```!
python3 "${CLAUDE_PLUGIN_ROOT}/scripts/eaa_start_planning.py" $ARGUMENTS
```
