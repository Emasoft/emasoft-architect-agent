# Bun Advanced Features: Dynamic Imports

> **Part 6 of 10** | See [bun-advanced-features.md](./bun-advanced-features.md) for the complete index.
...
- **Previous**: [Part 5: Monorepo and Workspaces](./bun-advanced-features-part5-monorepo-workspaces.md)
- **Next**: [Part 7: Native Modules](./bun-advanced-features-part7-native-modules.md)
- **Related**: [Part 1: Code Splitting](./bun-advanced-features-part1-code-splitting-treeshaking.md) - For build-time splitting
