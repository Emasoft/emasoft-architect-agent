# Bun Advanced Features: CDN and Browser Usage

> **Part 4 of 10** | See [bun-advanced-features.md](./bun-advanced-features.md) for the complete index.
...
- **Previous**: [Part 3: Standalone Executables](./bun-advanced-features-part3-standalone-executables.md)
- **Next**: [Part 5: Monorepo and Workspaces](./bun-advanced-features-part5-monorepo-workspaces.md)
- **Related**: [Part 1: Code Splitting](./bun-advanced-features-part1-code-splitting-treeshaking.md) - For splitting browser bundles
