# Bun Advanced Features: Edge Cases

> **Part 9 of 10** | See [bun-advanced-features.md](./bun-advanced-features.md) for the complete index.
...
**Example: Conditional JSON handling**

```javascript
// build.js
const env = process.env.NODE_ENV || 'development';

const loaderConfig = env === 'production'
  ? {}  // Default: parse JSON into objects
  : {
      '.json': 'text'  // Development: keep as strings for inspection
    };
...
- Default JSON import creates object literals in the bundle
- Custom loaders allow treating JSON as plain text
- Text-loaded JSON requires manual `JSON.parse()`
- Large JSON files benefit from keeping as strings when inlined
- For truly large datasets, use dynamic imports or fetch instead

---

## Cross-References

- **Previous**: [Part 8: JSON Imports](./bun-advanced-features-part8-json-imports.md)
- **Next**: [Part 10: Troubleshooting](./bun-advanced-features-part10-troubleshooting.md)
- **Related**: [Part 5: Monorepo and Workspaces](./bun-advanced-features-part5-monorepo-workspaces.md) - Full monorepo guide
- **Related**: [Part 7: Native Modules](./bun-advanced-features-part7-native-modules.md) - Full native module guide
