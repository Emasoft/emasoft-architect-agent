...
def get_planning_step_guidance(step_number: int, total_steps: int) -> dict[str, Any]:
...
def get_review_step_guidance(step_number: int, total_steps: int) -> dict[str, Any]:
...
""",
    ...
    print("=" * 80)
    print(
        f"PLANNER - {phase_label} PHASE - Step {args.step_number} of {args.total_steps}"
    )
    print("=" * 80)
    print()
    print(f"STATUS: {'phase_complete' if is_complete else 'in-progress'}")
    print()
    print("YOUR THOUGHTS:")
    print(args.thoughts)
    print()
