...
def get_step_1_guidance(plan_file: str, thoughts: str) -> dict[str, list[str] | str]:
    """Step 1: Execution Planning - analyze plan, detect reconciliation."""
...
def get_step_2_guidance(plan_file: str) -> dict[str, list[str] | str]:
...
def get_step_3_guidance(plan_file: str) -> dict[str, list[str] | str]:
    """Step 3: Milestone Execution - delegate to agents, run tests."""
    return {
        "actions": [
            "MILESTONE EXECUTION",
...
def get_step_4_guidance(plan_file: str) -> dict[str, list[str] | str]:
    """Step 4: Post-Implementation QR - quality review."""
    return {
        "actions": [
...
def get_step_5_guidance(plan_file: str) -> dict[str, list[str] | str]:
...
def get_step_6_guidance(plan_file: str) -> dict[str, list[str] | str]:
...
def get_step_7_guidance(plan_file: str) -> dict[str, list[str] | str]:
...
def get_step_guidance(
    step_number: int, plan_file: str, thoughts: str
...
""",
    ...
    parser.add_argument(
        "--step-number", type=int, required=True, help="Current step (1-7)"
    )
    parser.add_argument(
    ...
    print("=" * 80)
    print(
        f"EXECUTOR - Step {args.step_number} of 7: "
        f"{step_names.get(args.step_number, 'Unknown')}"
    )
    print("=" * 80)
    print()
