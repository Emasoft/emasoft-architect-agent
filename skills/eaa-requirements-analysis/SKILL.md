...
- [start-planning-procedure.md](references/start-planning-procedure.md) - Detailed /start-planning command procedure, prerequisites, and post-initialization steps
- [requirement-management.md](references/requirement-management.md) - Complete guide to adding, modifying, and removing requirements and modules
- [plan-approval-transition.md](references/plan-approval-transition.md) - Approval validation checks, GitHub Issue creation, and state transitions
- [state-file-format.md](references/state-file-format.md) - YAML frontmatter schema, field definitions, and state file lifecycle
- [troubleshooting.md](references/troubleshooting.md) - Comprehensive troubleshooting for all planning commands and state recovery
