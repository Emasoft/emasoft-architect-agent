...
**Previous:** [Part 4 - Browser Builds (CDN and Browser Usage)](./bun-advanced-features-part4-browser-builds.md)

**Next:** [Part 6 - Lazy Loading (Dynamic Imports)](./bun-advanced-features-part6-lazy-loading.md)
